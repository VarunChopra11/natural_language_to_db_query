...
A tool that converts natural language questions about Ethereum blockchain data into SQL queries, executes them against a PostgreSQL database, and displays the results in a user-friendly interface.
...
- Visualize query results in a **clean web interface**
...
- `app/llm.py` – Handles natural language processing with Gemini
- `app/query.py` – Manages DB connection and query execution
...
This will start the web interface at [http://localhost:8501](http://localhost:8501), where you can:

- Ask natural language questions about Ethereum data
...
- `"Show the last 5 transactions with value over 1 ETH"`
- `"What was the average gas price in the last 100 blocks?"`
- `"Find the top 10 miners by number of blocks mined"`
- `"Show all withdrawals to address 0xb9d7934878b5fb9610b3fe8a5e441e8fad7e293f"`
